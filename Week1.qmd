...
![Active remote sensors emit their own signal, while passive remote sensors detect natural radiation that is emitted or reflected by the object](image-5.jpeg){width="75%"}
:::
...
::: {style="text-align: center;"}
![Spectral Signature](spectralsignature.png){width="55%"}
:::

::: {style="text-align: center;"}
![Terrain Ruggedness Index](terrainruggednessindex.png){width="75%"}
:::

Here, I have built a true-colour composite from the red, green, and blue bands of the Sentinel-2 imagery.

::: {style="text-align: center;"}
![True Colour Composite](TCCKamloops.png){width="75%"}
:::
