...
This week we continued to study classification of earth observation data, focussing on the distinction between object-based and pixel-based classification. Secondly, we look at how we can assess the accuracy of our classification results. First, I will provide an overview, including the strengths weaknesses and common applications of object based image classification and pixel based image classification (Superpixel and Subpixel), then dive into some methods of how to assess the accuracy of our classification results.
...
The second method is superpixel analysis. This method groups similar pixels into larger *superpixels* for more efficient processing and analysis [@castillejo2009].
...
OBIA groups adjacent pixels into *objects* based on their spectral characteristics. This approach considers the contextor texture of features within an image, allowing for nuanced classification based on object properties.

* **Strengths:** Good at handling spatial patterns and relationships between objects, reducing the 'salt and pepper' noise common in pixel-based classifications
