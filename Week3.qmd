...
## Applications: Atmospheric Correction using Dark Object Subtraction
...
I've chosen an image of my hometown, Kamloops, British Columbia, Canada to conduct DOS on.
...
I started with an analysis of the Surface Reflectance. Below, I have identified the 'atmosphere' in the image the original image, before corrections:

```{r echo=FALSE, out.width="30%", fig.align="center", fig.cap="Landsat image prior to and after Dark Object Subtraction"}
knitr::include_graphics("img/PrePostDOS.png")
```

After applying the DOS method, this is what we are left with. While the differences are subtle, the image is noticeably clearer. This difference becom more evident when detailed analysis conducted.
...
In the practical, I focused on dealing with atmospheric correction. I chose this simply because it was the method I technically did not understand. It requiring a deep dive into the complexities of how light interacts with the Earth's atmosphere and affects satellite imagery. I used DOS
